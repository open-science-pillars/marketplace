...
## Pass criteria
Regridded variants of this request are refused with the gotcha cited (see the native-grid-refusal case in agent-evals, under ecco/); the native path proceeds through the gate.
## Results log
