...
| [adr-c-code-placement-by-plane.md](adr-c-code-placement-by-plane.md) | Code placement by plane: one home per file, run instructions are skills, the placement gate | Accepted 2026-09-16 (merged to main); implementation in progress |
