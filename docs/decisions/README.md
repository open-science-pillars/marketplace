...
| [adr-c-code-placement-by-plane.md](adr-c-code-placement-by-plane.md) | Code placement by plane: one home per file, run instructions are skills, the placement gate | Proposed 2026-09-16 |
